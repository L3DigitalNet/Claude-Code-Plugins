...
| uv-strict-python | 0.1.0 | Released 2026-06-09 (tag `uv-strict-python/v0.1.0`, GitHub release published). Initial release — Python Tooling SSOT Standard: uv + Ruff + BasedPyright (strict) + pytest/coverage + pip-audit. Hook shim layer redirects bare `pip`/`python`/`pipx` to uv equivalents. |
