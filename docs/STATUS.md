...
- Marketplace `l3digitalnet-plugins` lists eight plugins; all seven actively released plugins are at their latest tag with no unreleased changes.
- The repository uses direct commits to `main`; plugin releases go through the release-pipeline workflow.
