...
3. Display the staged changes and proposed message as labelled context before the push gate:
   ...
   (The push gate below is where the user can abort — nothing has been pushed yet.)
...
- options:
  ...
  2. label: `"Abort"`, description: `"Cancel — local commit (if any) stays on main, nothing pushed"`
If "Abort" → report "Quick push aborted." and stop.
