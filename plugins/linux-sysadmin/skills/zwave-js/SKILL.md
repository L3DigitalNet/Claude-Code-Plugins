...
description: >
  ...
  restore, OTA firmware updates, MQTT integration, and troubleshooting. Triggers
  on: Z-Wave, zwave, zwave-js, Z-Wave JS, zwave stick, Z-Wave devices,
  zwavejs2mqtt, zwave-js-ui, Z-Wave controller, Z-Wave mesh, Z-Wave inclusion,
  Z-Wave exclusion, Z-Wave USB, 700 series, 800 series, Aeotec, Z-Stick.
globs: []
---
