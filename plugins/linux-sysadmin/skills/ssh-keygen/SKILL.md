...
name: ssh-keygen
description: >
  ssh-keygen SSH key management: invoked when the user asks about ssh-keygen,
  SSH key, generate SSH key, SSH keypair, authorized_keys, known_hosts,
  fingerprint, key signing, SSH certificate, or ed25519. Covers key generation,
  passphrase management, fingerprint display, public key extraction, known_hosts
  management, format conversion, OpenSSH certificate signing, and signature
  verification.
globs:
  - "**/.ssh/authorized_keys"
  - "**/.ssh/known_hosts"
