...
export async function syncToCache(worktreePath, cachePath) {
    ...
    if (rsyncResult.exitCode !== 0) {
        ...
        throw new PTHError(PTHErrorCode.CACHE_SYNC_FAILED, `rsync failed (exit ${rsyncResult.exitCode})`, { stderr: rsyncResult.stderr });
    }
}
export function detectCachePath(pluginName) {
    return path.join(os.homedir(), '.claude', 'plugins', 'cache', pluginName);
}
//# sourceMappingURL=cache-sync.js.map