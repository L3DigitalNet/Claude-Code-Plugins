...
- [ ] **uv-strict-python patch release pending** — conformance fixes committed (`e57850f`) but unreleased; run `/release-pipeline:release` for the version bump + tag + GitHub release.
