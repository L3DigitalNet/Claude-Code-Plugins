...
- spec-pipeline plugin implemented (2026-07-02): all 14 plan tasks executed subagent-driven with per-task + final whole-branch review; specpipe validator CLI (stdlib-only, 101 tests), templates, migrated `author`/`execute-phase` skills, utility commands, marketplace entry. Unreleased — 0.1.0 tag pending.
